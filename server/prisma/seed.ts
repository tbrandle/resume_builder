...
const masterResume = {
  ...
  personal_details: {
    ...
    fields: [
      { id: "1", label: "first_name", type: "text", value: "Tim" },
      { id: "2", label: "last_name", type: "text", value: "Brandle" },
      { id: "3", label: "job_title", type: "text", value: "Senior Software Developer" },
      {
        id: "4",
      ...
      { id: "5", label: "phone_number", type: "phone", value: "720-281-6350" },
      { id: "6", label: "email", type: "email", value: "tbrandle53@gmail.com" },
    ],
  },
  social_media: {
    linked_in: "",
    ...
    portfolio: "",
    fields: [
      { id: "7", label: "linked_in", type: "text", value: "" },
      { id: "8", label: "github", type: "text", value: "" },
      { id: "9", label: "portfolio", type: "text", value: "" },
    ],
  },
  skills: [
    {
      ...
      id: "10",
      fields: [
        { id: "11", label: "skill", type: "text", value: "JavaScript" },
        { id: "12", label: "skill_level", type: "select", value: "Expert", options: ["Novice", "Beginner", "Skillful", "Experienced", "Expert"] },
      ],
    },
    {
      skill: "React",
      ...
      id: "22",
      fields: [
        { id: "23", label: "skill", type: "text", value: "React" },
        { id: "24", label: "skill_level", type: "select", value: "Expert", options: ["Novice", "Beginner", "Skillful", "Experienced", "Expert"] },
      ],
    },
    {
      skill: "Redux",
      ...
      id: "28",
      fields: [
        { id: "29", label: "skill", type: "text", value: "Redux" },
        { id: "30", label: "skill_level", type: "select", value: "Experienced", options: ["Novice", "Beginner", "Skillful", "Experienced", "Expert"] },
      ],
    },
    {
      skill: "Typescript",
      ...
      id: "100",
      fields: [
        { id: "101", label: "skill", type: "text", value: "Typescript" },
        { id: "102", label: "skill_level", type: "select", value: "Expert", options: ["Novice", "Beginner", "Skillful", "Experienced", "Expert"] },
      ],
    },
    {
      skill: "Next.js",
      ...
      id: "34",
      fields: [
        { id: "35", label: "skill", type: "text", value: "Next.js" },
        { id: "36", label: "skill_level", type: "select", value: "Experienced", options: ["Novice", "Beginner", "Skillful", "Experienced", "Expert"] },
      ],
    },
    {
      skill: "Node.js",
      ...
      id: "40",
      fields: [
        { id: "41", label: "skill", type: "text", value: "Node.js" },
        { id: "42", label: "skill_level", type: "select", value: "Skillful", options: ["Novice", "Beginner", "Skillful", "Experienced", "Expert"] },
      ],
    },
    {
      skill: "Java",
      ...
      id: "46",
      fields: [
        { id: "47", label: "skill", type: "text", value: "Java" },
        { id: "48", label: "skill_level", type: "select", value: "Skillful", options: ["Novice", "Beginner", "Skillful", "Experienced", "Expert"] },
      ],
    },
    {
      skill: "Spring Boot",
      ...
      id: "52",
      fields: [
        { id: "53", label: "skill", type: "text", value: "Spring Boot" },
        { id: "54", label: "skill_level", type: "select", value: "Skillful", options: ["Novice", "Beginner", "Skillful", "Experienced", "Expert"] },
      ],
    },
    {
      skill: "Docker",
      ...
      id: "58",
      fields: [
        { id: "59", label: "skill", type: "text", value: "Docker" },
        { id: "60", label: "skill_level", type: "select", value: "Experienced", options: ["Novice", "Beginner", "Skillful", "Experienced", "Expert"] },
      ],
    },
    {
      skill: "Kubernetes",
      ...
      id: "64",
      fields: [
        { id: "65", label: "skill", type: "text", value: "Kubernetes" },
        { id: "66", label: "skill_level", type: "select", value: "Skillful", options: ["Novice", "Beginner", "Skillful", "Experienced", "Expert"] },
      ],
    },
    {
      skill: "Kafka",
      ...
      id: "70",
      fields: [
        { id: "71", label: "skill", type: "text", value: "Kafka" },
        { id: "72", label: "skill_level", type: "select", value: "Skillful", options: ["Novice", "Beginner", "Skillful", "Experienced", "Expert"] },
      ],
    },
    {
      skill: "CSS",
      ...
      id: "76",
      fields: [
        { id: "77", label: "skill", type: "text", value: "CSS" },
        { id: "78", label: "skill_level", type: "select", value: "Experienced", options: ["Novice", "Beginner", "Skillful", "Experienced", "Expert"] },
      ],
    },
    {
      skill: "PostgresQL",
      ...
      id: "82",
      fields: [
        { id: "83", label: "skill", type: "text", value: "PostgresQL" },
        { id: "84", label: "skill_level", type: "select", value: "Skillful", options: ["Novice", "Beginner", "Skillful", "Experienced", "Expert"] },
      ],
    },
  ],
  employment_history: [
    {
      ...
      id: "13",
      fields: [
        { id: "14", label: "job_title", type: "text", value: "Senior Software Developer" },
        { id: "15", label: "employer", type: "text", value: "ThoughtWorks" },
        { id: "16", label: "city", type: "text", value: "Denver" },
        { id: "17", label: "state", type: "text", value: "CO" },
        { id: "18", label: "date_start", type: "text", value: "Jan, 2021" },
        { id: "19", label: "date_end", type: "text", value: "Present" },
        {
          id: "20",
          label: "description",
          type: "html",
    ...
    },
    {
      ...
      id: "21",
      fields: [
        { id: "22", label: "job_title", type: "text", value: "Software Developer" },
        { id: "23", label: "employer", type: "text", value: "ThoughtWorks" },
        { id: "24", label: "city", type: "text", value: "Denver" },
        { id: "25", label: "state", type: "text", value: "CO" },
        { id: "26", label: "date_start", type: "text", value: "Jun, 2019" },
        { id: "27", label: "date_end", type: "text", value: "Jan 2021" },
        {
          id: "28",
          label: "description",
          type: "html",
    ...
    },
    {
      ...
      id: "52",
      fields: [
        { id: "53", label: "job_title", type: "text", value: "Software Developer" },
        { id: "54", label: "employer", type: "text", value: "Bowtie.co" },
        { id: "55", label: "city", type: "text", value: "Denver" },
        { id: "56", label: "state", type: "text", value: "CO" },
        { id: "57", label: "date_start", type: "text", value: "Oct, 2017" },
        { id: "58", label: "date_end", type: "text", value: "Jun, 2019" },
        {
          id: "59",
          label: "description",
          type: "html",
  ...
  education: [
    {
      ...
      id: "10",
      fields: [
        { id: "11", label: "school", type: "text", value: "Turing School of Software and Design" },
        { id: "12", label: "degree", type: "text", value: "Front-end Development" },
        { id: "13", label: "city", type: "text", value: "Denver" },
        { id: "14", label: "state", type: "text", value: "CO" },
      ],
    },
    {
      ...
      id: "30",
      fields: [
        { id: "31", label: "school", type: "text", value: "Colorado State University" },
        { id: "32", label: "degree", type: "text", value: "BS, Business Administration" },
        { id: "33", label: "city", type: "text", value: "Fort Collins" },
        { id: "34", label: "state", type: "text", value: "CO" },
      ],
    },
  ],
};
...
async function main() {
  ...
  if (count > 0) {
    console.log(`Database already has ${count} resume(s). Skipping seed.`);
    return;
  }

  await prisma.resume.create({ data: { resume: masterResume } });
  console.log("Seeded master resume.");
}
